               ...
               with font-awesome or any other icon font library -->
				<li class="nav-item"><a href="#" class="nav-link">
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a
							href="<c:url value="/addEmployee"/>"
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>Add Employee</p>
						</a></li>
						<li class="nav-item"><a
							href="<c:url value="/viewEmployee"/>" class="nav-link">
				...
				<li class="nav-item"><a href="#" class="nav-link">
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a
							href="../../pages/forms/projectForm.html" class="nav-link"> <i
				...
				<li class="nav-item"><a href="#" class="nav-link">
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a
							href="../../pages/forms/employeeAssignForm.html" class="nav-link">
								<i class="far fa-circle nav-icon"></i>
								<p>Assign Project</p>
						</a></li>
						<li class="nav-item"><a
							href="../../pages/tables/employee-project.html" class="nav-link">
								<i class="far fa-circle nav-icon"></i>
